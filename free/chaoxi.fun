#!MANAGED-CONFIG https://cxsub.club/link/bpRgmrtR8neRrDXD?clash=1

#---------------------------------------------------#
## 上次更新于：2023-08-03 08:49:10
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '62060:ce2wPowzumpEnPjB'
    obfs: http_simple
    obfs-param: bd50462060.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
