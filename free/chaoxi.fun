#!MANAGED-CONFIG https://cxsub.club/link/yKFA1RbJSONF5jwf?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-02 06:31:23
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '72120:CLl2Xy80Zix11weq'
    obfs: http_simple
    obfs-param: eb69b72120.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
