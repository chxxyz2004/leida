#!MANAGED-CONFIG https://cxsub.club/link/bHsbTaQ0LKToXaSv?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-18 12:34:27
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75890:ssf1FD7uBbXKuuYP'
    obfs: http_simple
    obfs-param: fc86275890.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
