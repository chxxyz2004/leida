#!MANAGED-CONFIG https://cxsub.club/link/gKL6kjItTb9l5eqA?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-08 02:31:03
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75543:8XF6PCYexHzicMha'
    obfs: http_simple
    obfs-param: bf88375543.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
