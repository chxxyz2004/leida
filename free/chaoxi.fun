#!MANAGED-CONFIG https://cxsub.club/link/DglYhCAr6EhI4AeS?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-04 12:29:56
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '72519:a2iyrbUMBkZl8EIM'
    obfs: http_simple
    obfs-param: a1a2872519.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
