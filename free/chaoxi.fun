#!MANAGED-CONFIG https://cxsub.club/link/4B35muxuvy3xUfZs?clash=1

#---------------------------------------------------#
## 上次更新于：2023-08-10 10:34:04
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '64913:dbmiIUGdDVLp9KTu'
    obfs: http_simple
    obfs-param: a7c0a64913.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
