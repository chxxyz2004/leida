#!MANAGED-CONFIG https://cxsub.club/link/vAND8xOWggRDBlBb?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-09 02:30:46
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75585:31zpF02QqaAtHemG'
    obfs: http_simple
    obfs-param: 7550875585.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
