#!MANAGED-CONFIG https://cxsub.club/link/lFdr8FElNBx9Bo1j?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-09 10:30:18
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '73882:C2BFZGiX1n44d3Ek'
    obfs: http_simple
    obfs-param: a395673882.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
