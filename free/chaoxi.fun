#!MANAGED-CONFIG https://cxsub.club/link/TaGK38OugsHlYSHz?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-20 02:32:57
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75019:jfdpkcf1GUdM1PTS'
    obfs: http_simple
    obfs-param: ea30c75019.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
