#!MANAGED-CONFIG https://cxsub.club/link/oD4GZt4OPoKHx6Tu?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-23 06:32:41
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '76056:FybjT6DLHCoeCS8n'
    obfs: http_simple
    obfs-param: 507cf76056.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
