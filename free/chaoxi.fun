#!MANAGED-CONFIG https://cxsub.club/link/7T6ivI5cl2MY6ozX?clash=1

#---------------------------------------------------#
## 上次更新于：2023-08-15 06:31:18
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '66501:GzDBaifosiUIAjLp'
    obfs: http_simple
    obfs-param: 0a54a66501.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
