#!MANAGED-CONFIG https://cxsub.club/link/tfapVYGwrM3gIG4h?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-15 02:31:36
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75804:r4rPhxxfWjIwAivm'
    obfs: http_simple
    obfs-param: 29ef875804.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
