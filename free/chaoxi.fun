#!MANAGED-CONFIG https://cxsub.club/link/R4VQDLgmudrIAkWR?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-28 10:31:54
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75292:P2C2P1PE3SIgMcbL'
    obfs: http_simple
    obfs-param: e8f8e75292.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
