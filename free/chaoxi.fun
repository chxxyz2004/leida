#!MANAGED-CONFIG https://cxsub.club/link/JvWOVLUeKxVbqexW?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-20 06:33:00
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75966:GVTdb753ZQOePXeg'
    obfs: http_simple
    obfs-param: dc7a875966.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
