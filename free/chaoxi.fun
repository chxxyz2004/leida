#!MANAGED-CONFIG https://cxsub.club/link/ZNAWt4XmZTrh9SYC?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-15 10:31:20
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '74862:ovYLoh8GUEOEEbpg'
    obfs: http_simple
    obfs-param: 1bba374862.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
