#!MANAGED-CONFIG https://cxsub.club/link/kKopqZC50dnJRLoR?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-19 02:31:23
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75929:JK6H8AwrKVtcgXUZ'
    obfs: http_simple
    obfs-param: bc08375929.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
