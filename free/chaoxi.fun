#!MANAGED-CONFIG https://cxsub.club/link/HFC6IBZoVQF5ubfr?clash=1

#---------------------------------------------------#
## 上次更新于：2023-08-14 12:33:20
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '66055:gCGn21TblSsM752M'
    obfs: http_simple
    obfs-param: f398f66055.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
