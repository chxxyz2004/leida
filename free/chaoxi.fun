#!MANAGED-CONFIG https://cxsub.club/link/gt1VTP86jm7VLhR4?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-21 02:33:11
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '75057:tUdWa16ZjR19US2b'
    obfs: http_simple
    obfs-param: 85f4f75057.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
