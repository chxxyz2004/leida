#!MANAGED-CONFIG https://yjssub.pro/link/rwzeKzXBETf5y9LD?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-24 04:27:00
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38567:qgQBU97yCDhPE5OV'
    obfs: http_simple
    obfs-param: 7739238567.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
