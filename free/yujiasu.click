#!MANAGED-CONFIG https://yjssub.pro/link/hFIBGpA692FeJmJI?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-11 02:34:09
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38118:v61IRGgbRmsw6dtI'
    obfs: http_simple
    obfs-param: 3937f38118.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
