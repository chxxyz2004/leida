#!MANAGED-CONFIG https://yjssub.pro/link/dkvHF6WPe1E5jbYK?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-18 10:31:31
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38377:iZ4PEiYrxpNbOCnu'
    obfs: http_simple
    obfs-param: eaec938377.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
