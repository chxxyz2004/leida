#!MANAGED-CONFIG https://yjssub.pro/link/zhYqPkubVFsSR002?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-08 02:31:30
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38002:lcckOhaxsdENt8w0'
    obfs: http_simple
    obfs-param: b2c4738002.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
