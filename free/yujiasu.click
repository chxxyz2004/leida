#!MANAGED-CONFIG https://yjssub.pro/link/DZIriRMcSbdwvMfv?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-13 04:27:04
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38170:y5I2cAhicLggM2gy'
    obfs: http_simple
    obfs-param: c072538170.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
