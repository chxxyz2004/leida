#!MANAGED-CONFIG https://yjssub.pro/link/vN8NPRh7FWoRoHx1?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-28 02:33:17
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37681:NPTVpGnq6CBEkRGH'
    obfs: http_simple
    obfs-param: 99e0e37681.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
