#!MANAGED-CONFIG https://yjssub.pro/link/aeEcW5Wip4wwJ1M1?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-16 09:34:14
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38277:egWUN2dTHfADprUD'
    obfs: http_simple
    obfs-param: b998d38277.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
