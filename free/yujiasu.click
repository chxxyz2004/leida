#!MANAGED-CONFIG https://yjssub.pro/link/y2GbleJsBSMsptB7?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-21 06:30:20
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38459:LlddIsTIEOWI2gTg'
    obfs: http_simple
    obfs-param: fafca38459.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
