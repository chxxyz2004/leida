#!MANAGED-CONFIG https://yjssub.pro/link/aoxQqmmgAdBqVQOp?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-10 06:33:42
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38090:eL2IdmArkIQUfBJT'
    obfs: http_simple
    obfs-param: 5387438090.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
