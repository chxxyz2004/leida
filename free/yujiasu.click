#!MANAGED-CONFIG https://yjssub.pro/link/JjQkkvakOw3ltbBI?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-09 02:31:13
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38037:SvK4wNR9WuJXFCGC'
    obfs: http_simple
    obfs-param: c8f1e38037.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
