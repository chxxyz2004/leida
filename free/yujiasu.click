#!MANAGED-CONFIG https://yjssub.pro/link/iOe1z7wlH2WNnJzN?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-04 06:31:10
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37872:LfEnVO7WKerLcItY'
    obfs: http_simple
    obfs-param: 3ebd137872.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
