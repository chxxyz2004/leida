#!MANAGED-CONFIG https://yjssub.pro/link/tBEHm9EKKlm8gB9V?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-22 02:31:26
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38506:oyamc0xMKgDyhW72'
    obfs: http_simple
    obfs-param: 7ddb038506.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
