#!MANAGED-CONFIG https://yjssub.pro/link/bes8iG5tJSdcqhkm?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-29 10:33:25
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37709:dpRCgaCZ6xhkueic'
    obfs: http_simple
    obfs-param: e2a4637709.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
