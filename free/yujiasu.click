#!MANAGED-CONFIG https://yjssub.pro/link/3ZiTyxOrjINd2YKR?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-21 10:30:21
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38465:mikRmAEGByFdUW2v'
    obfs: http_simple
    obfs-param: bcbb438465.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
