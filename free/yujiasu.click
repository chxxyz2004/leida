#!MANAGED-CONFIG https://yjssub.pro/link/JFDMrDCM9XttLULG?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-15 10:28:51
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38262:edbHA5GQG40jCmCO'
    obfs: http_simple
    obfs-param: edb3238262.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
