#!MANAGED-CONFIG https://yjssub.pro/link/o2XNYCPuyp4USCDg?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-10 10:32:48
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38080:dCFIVkDcnAxbVCsh'
    obfs: http_simple
    obfs-param: c6c1d38080.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
