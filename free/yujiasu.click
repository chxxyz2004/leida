#!MANAGED-CONFIG https://yjssub.pro/link/tJmR9OhOBzSpciDZ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-06 02:34:10
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37936:gd6Vobzhv7lEHuw5'
    obfs: http_simple
    obfs-param: dfc5a37936.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
