#!MANAGED-CONFIG https://yjssub.pro/link/imT58wVtEjbMWQO2?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-16 12:33:12
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38264:bHQMWPgvUsSY49CB'
    obfs: http_simple
    obfs-param: f36a138264.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
