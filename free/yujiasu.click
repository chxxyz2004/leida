#!MANAGED-CONFIG https://yjssub.pro/link/uzKoe6y7JB4C602e?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-20 02:33:07
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38436:JCCJ0BGZQAjoCOCm'
    obfs: http_simple
    obfs-param: 43fbb38436.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
