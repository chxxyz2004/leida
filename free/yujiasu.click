#!MANAGED-CONFIG https://yjssub.pro/link/GEEvIh61ppAZXgdZ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-27 10:32:13
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37658:43cr2Xfay3BmBtMU'
    obfs: http_simple
    obfs-param: e0b6337658.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
