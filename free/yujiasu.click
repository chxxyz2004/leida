#!MANAGED-CONFIG https://yjssub.pro/link/b3kacTu3ybc1feja?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-11 09:31:39
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38110:IAnwlySVFhfXuVnS'
    obfs: http_simple
    obfs-param: 4f68238110.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
