#!MANAGED-CONFIG https://yjssub.pro/link/pdO35A1GUmBSgQ0D?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-18 09:32:22
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38354:mTvGXbDWOACBGrTk'
    obfs: http_simple
    obfs-param: 5ae7138354.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
