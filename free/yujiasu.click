#!MANAGED-CONFIG https://yjssub.pro/link/RGaRSlP7qAlLAWSy?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-04 10:33:31
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37878:1k98EkHkBxU0yIAh'
    obfs: http_simple
    obfs-param: ac77437878.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
