#!MANAGED-CONFIG https://yjssub.pro/link/h4nVaTNoeADE2MdL?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-02 10:33:34
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37812:3JVBvgTdKIrUtOia'
    obfs: http_simple
    obfs-param: 36d2437812.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
