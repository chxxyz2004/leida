#!MANAGED-CONFIG https://yjssub.pro/link/KaDvsdcsEOxEp3TB?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-13 12:35:50
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38164:uFbBeuLjCsYAZSo9'
    obfs: http_simple
    obfs-param: 8711838164.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
