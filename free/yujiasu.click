#!MANAGED-CONFIG https://yjssub.pro/link/GBcZSeNBFdRvUJVB?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-18 12:34:51
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38342:ReocW7AgSOYdUNJE'
    obfs: http_simple
    obfs-param: 89d1438342.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
