#!MANAGED-CONFIG https://yjssub.pro/link/555twhbBiMjOeVFB?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-10 08:47:23
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38094:lsLFziXpRhapJzXu'
    obfs: http_simple
    obfs-param: caee738094.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
