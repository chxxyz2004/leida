#!MANAGED-CONFIG https://yjssub.pro/link/ohGs9wiye11TVRyL?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-17 04:33:07
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38330:cKZMpfPSGstVfMlU'
    obfs: http_simple
    obfs-param: da94e38330.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
