#!MANAGED-CONFIG https://yjssub.pro/link/BSLrcSiKOJHaPLh7?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-03 02:34:05
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37852:5f01gvk9wtfM8edV'
    obfs: http_simple
    obfs-param: a3ce937852.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
