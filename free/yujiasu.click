#!MANAGED-CONFIG https://yjssub.pro/link/5fIO3Dlo4VLl66CL?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-19 09:32:03
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38392:9f2Uv2H85lt3U8f2'
    obfs: http_simple
    obfs-param: 88e5638392.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
