#!MANAGED-CONFIG https://yjssub.pro/link/7Kl0Mg1OehMI4CHJ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-25 12:31:07
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38617:l1xTHwBohRNb2jEG'
    obfs: http_simple
    obfs-param: d7bee38617.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
