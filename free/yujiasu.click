#!MANAGED-CONFIG https://yjssub.pro/link/INjT2hhE5T33qTbu?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-24 04:32:29
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38587:IHzvdgfYUhITpBtn'
    obfs: http_simple
    obfs-param: 3d90838587.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
