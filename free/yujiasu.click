#!MANAGED-CONFIG https://yjssub.pro/link/SxILMEYFB2sOSEnr?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-09 12:32:22
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38033:KW4zbPUnTEuTZ5HF'
    obfs: http_simple
    obfs-param: 65abb38033.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
