#!MANAGED-CONFIG https://yjssub.pro/link/LzdWfza1SpENwKqx?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-27 02:33:11
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37630:FrMUPZrt7sHYsgVT'
    obfs: http_simple
    obfs-param: fe8aa37630.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
