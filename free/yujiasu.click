#!MANAGED-CONFIG https://yjssub.pro/link/MgFGRzAsBLLmYPuf?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-04 02:33:47
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37886:S63DnQ8GfnMI5BPa'
    obfs: http_simple
    obfs-param: ce47d37886.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
