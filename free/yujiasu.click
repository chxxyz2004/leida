#!MANAGED-CONFIG https://yjssub.pro/link/ztvvRT24XaWkOTeZ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-26 12:31:03
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38653:zF3AfPAcRe8FrrOZ'
    obfs: http_simple
    obfs-param: f46fc38653.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
