#!MANAGED-CONFIG https://yjssub.pro/link/ZNLnTaJv0z6CnxHl?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-26 06:29:59
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38644:COHFEWikn4OvkOyf'
    obfs: http_simple
    obfs-param: 6c97638644.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
