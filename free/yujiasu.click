#!MANAGED-CONFIG https://yjssub.pro/link/1qWNkLInTVMWm203?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-26 04:33:32
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37612:xJnsv7Rb6e5JlWrf'
    obfs: http_simple
    obfs-param: 6ead037612.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
