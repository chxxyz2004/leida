#!MANAGED-CONFIG https://yjssub.pro/link/WMM1MXzJXnZmpVnn?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-11 10:33:11
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38112:NcZZj6mOnu9PNQ0t'
    obfs: http_simple
    obfs-param: dde2038112.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
