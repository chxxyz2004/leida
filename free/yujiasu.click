#!MANAGED-CONFIG https://yjssub.pro/link/4QqfupTfmwXvUZFI?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-23 10:32:13
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38558:pmpQ733xeOmkCrpt'
    obfs: http_simple
    obfs-param: ea1cb38558.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
