#!MANAGED-CONFIG https://yjssub.pro/link/qJKLhuMAvPabZ0Ri?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-29 06:33:38
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37720:T0Ry00KYbJmpdi5L'
    obfs: http_simple
    obfs-param: e8f3037720.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
