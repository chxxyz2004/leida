#!MANAGED-CONFIG https://yjssub.pro/link/EUduVto2r0PwfEPe?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-08 06:31:02
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38023:7M6tQ701ad9CkuPd'
    obfs: http_simple
    obfs-param: c5f1438023.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
