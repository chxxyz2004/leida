#!MANAGED-CONFIG https://yjssub.pro/link/qJKrdBXPORCNhoLZ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-22 12:32:30
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38485:ZEfw6PuK6RVUqTLD'
    obfs: http_simple
    obfs-param: 528f038485.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
