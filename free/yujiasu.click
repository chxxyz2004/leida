#!MANAGED-CONFIG https://yjssub.pro/link/lBlqjmuAYjQnwROc?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-28 06:33:30
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37685:j6FDUaV3rUP1UAfY'
    obfs: http_simple
    obfs-param: ef02937685.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
