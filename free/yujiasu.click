#!MANAGED-CONFIG https://yjssub.pro/link/meIuUIFPWBIo9i0O?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-07 06:31:00
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37989:1u6UPB0cfTiRr81n'
    obfs: http_simple
    obfs-param: e218237989.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
