#!MANAGED-CONFIG https://yjssub.pro/link/jNirCiidDwYgp44d?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-17 08:48:05
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38338:FWV22PSOmYSNVuXv'
    obfs: http_simple
    obfs-param: 6c2d338338.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
