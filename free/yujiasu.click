#!MANAGED-CONFIG https://yjssub.pro/link/yHmMIvPmBIshKvVZ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-21 10:28:17
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38483:PPfWDO5bat7doc1L'
    obfs: http_simple
    obfs-param: c450d38483.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
