#!MANAGED-CONFIG https://yjssub.pro/link/FYXCdw62dKgSInTo?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-23 04:32:29
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38547:8JYdSqdKCnIirk3J'
    obfs: http_simple
    obfs-param: beede38547.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
