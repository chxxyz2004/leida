#!MANAGED-CONFIG https://yjssub.pro/link/Wr7d4sQDHnwldLMA?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-14 02:31:40
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38218:sI7wsg0SGDSf3WaE'
    obfs: http_simple
    obfs-param: 772c538218.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
