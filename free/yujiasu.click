#!MANAGED-CONFIG https://yjssub.pro/link/oZ6pflD9Emeeoibg?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-15 12:32:39
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38232:S6f0guwPpS1qaLCv'
    obfs: http_simple
    obfs-param: cccd638232.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
