#!MANAGED-CONFIG https://yjssub.pro/link/TTGRtgptTmtf9swy?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-30 10:31:17
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37744:PSve4y9DJWKS1aOv'
    obfs: http_simple
    obfs-param: f673d37744.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
