#!MANAGED-CONFIG https://yjssub.pro/link/H16q0ZXDfyL4ibwC?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-26 10:31:41
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38651:WQ7hClohpIscCCTX'
    obfs: http_simple
    obfs-param: 52d0038651.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
