#!MANAGED-CONFIG https://yjssub.pro/link/sbR7DumFLLoXEPbB?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-07 06:30:53
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37973:W4ULetPfoxJJquSQ'
    obfs: http_simple
    obfs-param: d8b2c37973.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
