#!MANAGED-CONFIG https://yjssub.pro/link/tACsmKnHhKOlO2Kc?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-09 09:33:12
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38045:ijhjhQwiSQtEdBoh'
    obfs: http_simple
    obfs-param: 7926038045.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
