#!MANAGED-CONFIG https://yjssub.pro/link/Q23XrGybPTMFGDU0?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-11 10:32:51
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38128:bC0CRzZsTJvgcNbP'
    obfs: http_simple
    obfs-param: d68c838128.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
