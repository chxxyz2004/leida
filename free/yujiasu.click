#!MANAGED-CONFIG https://yjssub.pro/link/1vOMH2eQ7Re9sX7v?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-16 04:33:41
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38288:esowYAMaFd0mucBx'
    obfs: http_simple
    obfs-param: a83c638288.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
