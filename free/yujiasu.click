#!MANAGED-CONFIG https://yjssub.pro/link/y30CLSOWAEv625MM?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-03 04:28:37
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37838:5EcjDVk09UcXUZQm'
    obfs: http_simple
    obfs-param: 7f65037838.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
