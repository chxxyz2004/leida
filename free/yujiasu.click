#!MANAGED-CONFIG https://yjssub.pro/link/sijuyAzGfeJhdyux?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-20 04:31:49
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38438:cayzwZhjbw7YyIOG'
    obfs: http_simple
    obfs-param: 04cab38438.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
