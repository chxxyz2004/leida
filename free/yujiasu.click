#!MANAGED-CONFIG https://yjssub.pro/link/4GoLrWTrn24GCexF?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-15 06:29:57
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38240:aqbdgTPh18iDOu8K'
    obfs: http_simple
    obfs-param: c436638240.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
