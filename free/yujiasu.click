#!MANAGED-CONFIG https://yjssub.pro/link/0IDUSMQEdp8IL9W6?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-04 12:36:05
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37864:eFdReWNI8j1h2e1h'
    obfs: http_simple
    obfs-param: 627d837864.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
