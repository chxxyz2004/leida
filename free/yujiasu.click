#!MANAGED-CONFIG https://yjssub.pro/link/TFX6323Rs2sfLM0n?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-15 04:26:12
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38238:EIeIu4Z2ffkEAzOv'
    obfs: http_simple
    obfs-param: abdc438238.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
