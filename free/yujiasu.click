#!MANAGED-CONFIG https://yjssub.pro/link/P8RLCnzI9AOQvgxw?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-21 02:31:07
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38473:JQqr76AIuQMg1z0A'
    obfs: http_simple
    obfs-param: 33e9838473.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
