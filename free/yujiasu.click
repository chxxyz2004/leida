#!MANAGED-CONFIG https://yjssub.pro/link/rHAYOcKbpXfWgnx5?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-28 02:33:34
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37664:syQVChLeKJey8wYm'
    obfs: http_simple
    obfs-param: d289537664.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
