#!MANAGED-CONFIG https://yjssub.pro/link/2LLhS3fMab0Fy8Q3?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-01 12:31:00
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37780:ACvHS7G62Db3eW3C'
    obfs: http_simple
    obfs-param: 70f9937780.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
