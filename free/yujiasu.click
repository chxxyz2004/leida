#!MANAGED-CONFIG https://yjssub.pro/link/1UQ5PIIuaETjqJVp?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-22 04:26:16
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38491:bgbVWSaUxObsGdgW'
    obfs: http_simple
    obfs-param: dfa7c38491.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
