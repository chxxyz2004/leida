#!MANAGED-CONFIG https://yjssub.pro/link/pqOwOlarjIBLEogt?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-26 06:31:09
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37597:RiGBoHPWPjTEpaEW'
    obfs: http_simple
    obfs-param: ec63037597.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
