#!MANAGED-CONFIG https://yjssub.pro/link/dTujYKq0Ty3eOkHm?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-25 02:32:53
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38621:StseJwxtUdKEiSA5'
    obfs: http_simple
    obfs-param: fd15f38621.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
