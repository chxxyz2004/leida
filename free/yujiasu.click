#!MANAGED-CONFIG https://yjssub.pro/link/wWCSjR4P3vyPEuPH?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-12 06:33:33
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38156:ZwRuEzQy8jupPYhT'
    obfs: http_simple
    obfs-param: aacd438156.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
