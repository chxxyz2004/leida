#!MANAGED-CONFIG https://yjssub.pro/link/fmFmEnAbSAxuzLlA?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-16 10:34:44
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38279:JjqUgYQK6eYW0OdK'
    obfs: http_simple
    obfs-param: ff34438279.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
