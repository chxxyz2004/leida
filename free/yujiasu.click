#!MANAGED-CONFIG https://yjssub.pro/link/kDIFnHsgbuMdkWlp?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-28 04:33:01
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37683:Lx51MGoIKlrcjJZ8'
    obfs: http_simple
    obfs-param: a571637683.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
