#!MANAGED-CONFIG https://yjssub.pro/link/IN2xleEX9Fq2VnfC?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-30 12:32:05
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37746:NfTLYOoHUJMOnMKM'
    obfs: http_simple
    obfs-param: bbb2337746.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
