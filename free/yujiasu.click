#!MANAGED-CONFIG https://yjssub.pro/link/z47GcJqXZAzChGqZ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-24 02:33:39
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38585:VabRqOsEeUgwVF1L'
    obfs: http_simple
    obfs-param: e132b38585.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
