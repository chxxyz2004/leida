#!MANAGED-CONFIG https://yjssub.pro/link/ExLDPCOcC6P6DpuW?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-06 06:30:55
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37940:zsKCZCvHdknhw7BB'
    obfs: http_simple
    obfs-param: 95fa137940.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
