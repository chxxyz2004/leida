#!MANAGED-CONFIG https://yjssub.pro/link/OwffdxWU9vwtrl6i?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-30 06:30:36
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37738:fqfUZd75OQx3zipY'
    obfs: http_simple
    obfs-param: 9abf437738.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
