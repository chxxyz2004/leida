#!MANAGED-CONFIG https://yjssub.pro/link/u4X4NLSYKg0pSP8Y?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-03 10:33:17
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37862:Hju6IpwfpBt6vHfA'
    obfs: http_simple
    obfs-param: 5b84037862.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
