#!MANAGED-CONFIG https://yjssub.pro/link/RthQi8vh08MDRl1C?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-09 06:35:11
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38058:8fs57doXwvYlhsPC'
    obfs: http_simple
    obfs-param: dd8c938058.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
