#!MANAGED-CONFIG https://yjssub.pro/link/JCwyszVa365uTPRQ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-26 08:45:33
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38667:E8J3Z3XGIhmTzEBS'
    obfs: http_simple
    obfs-param: e575038667.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
