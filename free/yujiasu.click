#!MANAGED-CONFIG https://yjssub.pro/link/cElwIIuuDzEvctWP?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-16 10:33:09
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38302:8gMhHLaxkG6h3QRa'
    obfs: http_simple
    obfs-param: bb95d38302.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
