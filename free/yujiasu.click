#!MANAGED-CONFIG https://yjssub.pro/link/jgBfGE6TY4CXTrFJ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-18 02:33:32
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38346:oWQ8UrDFEM9614zA'
    obfs: http_simple
    obfs-param: 9e1b338346.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
