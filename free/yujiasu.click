#!MANAGED-CONFIG https://yjssub.pro/link/WVzNxndNrO0NFVQV?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-26 10:34:19
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37603:yjJqI4S1Nu3u3sDf'
    obfs: http_simple
    obfs-param: aa14437603.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
