#!MANAGED-CONFIG https://yjssub.pro/link/yAp1N3e4JmPX3e7H?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-23 04:27:08
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38528:gom6pPN1mKOJDV9Z'
    obfs: http_simple
    obfs-param: bf81238528.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
