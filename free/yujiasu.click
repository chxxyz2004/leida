#!MANAGED-CONFIG https://yjssub.pro/link/f8sxlPCeNECxtQhB?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-22 08:42:21
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38518:CnrhT8xOdlTIU4jm'
    obfs: http_simple
    obfs-param: 60f8c38518.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
