#!MANAGED-CONFIG https://yjssub.pro/link/a1CMfEVWpN1KfzVH?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-23 02:33:36
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38543:vwd9bZ1aWZtpn3ZO'
    obfs: http_simple
    obfs-param: b875238543.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
