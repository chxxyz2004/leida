#!MANAGED-CONFIG https://yjssub.pro/link/WMdWwIDiBgfFr2du?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-28 12:31:52
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37677:r4N3Wi63POSGV9XC'
    obfs: http_simple
    obfs-param: 4338137677.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
