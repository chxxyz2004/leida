#!MANAGED-CONFIG https://yjssub.pro/link/L6Usz5GAsyZocKrC?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-22 09:36:26
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38497:4EVzh8jJc8uiBR2o'
    obfs: http_simple
    obfs-param: ef03f38497.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
