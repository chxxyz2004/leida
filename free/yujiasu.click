#!MANAGED-CONFIG https://yjssub.pro/link/w2WsFhWRhXa0CkQG?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-03 02:33:20
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37836:BmIErJaheztfRB4h'
    obfs: http_simple
    obfs-param: 85db737836.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
