#!MANAGED-CONFIG https://yjssub.pro/link/yNLLAogTs564W7KD?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-22 04:29:14
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38509:DToAeVjYrMxvS8jy'
    obfs: http_simple
    obfs-param: 91b2438509.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
