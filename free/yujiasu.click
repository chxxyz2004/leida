#!MANAGED-CONFIG https://yjssub.pro/link/vndVrnfO7CylMmut?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-04 02:33:55
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37868:jGq5ENKLHTUFuMza'
    obfs: http_simple
    obfs-param: fd8a137868.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
