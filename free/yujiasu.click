#!MANAGED-CONFIG https://yjssub.pro/link/BPs4pRVVFoHgGzxd?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-14 10:30:53
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38212:1MJ5kMhmoWNbHEDW'
    obfs: http_simple
    obfs-param: 4c36138212.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
