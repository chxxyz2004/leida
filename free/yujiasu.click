#!MANAGED-CONFIG https://yjssub.pro/link/oveZaZDQ97NrY2x7?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-28 12:35:33
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37660:qoduPjepyHKHY3X8'
    obfs: http_simple
    obfs-param: aa65c37660.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
