#!MANAGED-CONFIG https://yjssub.pro/link/OERXPxaWRQD1sJhC?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-03 10:33:35
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37846:OQTd4Ahv2bUe43P6'
    obfs: http_simple
    obfs-param: 72efe37846.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
