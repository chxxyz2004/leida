#!MANAGED-CONFIG https://yjssub.pro/link/EFfn1vTqGOrcsnCy?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-26 12:33:01
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38636:kRN7PdWmIgCDPdAv'
    obfs: http_simple
    obfs-param: 6e68738636.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
