#!MANAGED-CONFIG https://yjssub.pro/link/ZdW8wmLUBdVLyT5S?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-10 09:31:38
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38078:ABh7aVwR4VaTGNeh'
    obfs: http_simple
    obfs-param: 3fe2338078.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
