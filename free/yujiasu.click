#!MANAGED-CONFIG https://yjssub.pro/link/UXirvVuVk5ihARwQ?clash=1

#---------------------------------------------------#
## 上次更新于：2023-10-23 12:31:31
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '38539:mvaB0VJ6AtD9reVL'
    obfs: http_simple
    obfs-param: e274b38539.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
