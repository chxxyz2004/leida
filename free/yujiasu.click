#!MANAGED-CONFIG https://yjssub.pro/link/YRhWPBFWgNdUHfTu?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-29 02:33:20
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37715:RSWxt9QRtzIlYMLn'
    obfs: http_simple
    obfs-param: af3e937715.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
