#!MANAGED-CONFIG https://yjssub.pro/link/xfrO9G8FwqyUUoLy?clash=1

#---------------------------------------------------#
## 上次更新于：2023-09-29 02:32:47
#---------------------------------------------------#
...
proxies:
  -
    ...
    protocol-param: '37698:enDAcyDgJaEyNEap'
    obfs: http_simple
    obfs-param: c7c4b37698.microsoft.com
    udp: true
proxy-groups:
  -
    name: '🍃 Proxies'
